...
function commandExistsInPath(command: string, environment: NodeJS.ProcessEnv = process.env): boolean {
...
export { commandExistsInPath, configureLinuxPasswordStore, detectLinuxPasswordStore, getDesktopDescription }
