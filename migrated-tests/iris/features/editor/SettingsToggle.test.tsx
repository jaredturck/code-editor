/**
 * Keeps the IRIS-styled editor settings toggle's geometry and change callback stable.
 */

import { fireEvent, render, screen } from '@testing-library/react';
import { describe, expect, it, vi } from 'vitest';
import { Toggle } from '@/features/editor/components/SettingsModal';

describe('editor settings Toggle', () => {
