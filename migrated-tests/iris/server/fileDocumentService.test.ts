...
import { extractDocumentText } from '../../server/desktopBridge/services/fileDocumentService';
import {
  docxFixture,
  genericZipFixture,
  odpFixture,
...
describe('fileDocumentService', () => {
  it.each([
    [
      docxFixture('Word document search phrase'),
      'docx',
      'streaming-docx',
      'Word document search phrase',
    ],
    [
      xlsxFixture('Spreadsheet search phrase'),
      'xlsx',
      'streaming-xlsx',
      'Spreadsheet search phrase',
    ],
    [
      pptxFixture('Presentation search phrase'),
      'pptx',
      'streaming-pptx',
      'Presentation search phrase',
    ],
