...
export type ProviderProxyId = 'anthropic' | 'openai' | 'gemini' | 'deepseek' | 'openrouter' | 'opencode' | 'local'
...
// policy.
function assertProviderUrlAllowed(providerId: ProviderProxyId, rule: ProviderDestinationRule, url: URL): void {
