...
import { proxyRemoteRequest } from '../../backend/desktopBridge/services/bridgeServiceRuntime'
...
const proxyRequest = proxyRemoteRequest as (options: ProxyRequestOptions) => Promise<Record<string, unknown>>
