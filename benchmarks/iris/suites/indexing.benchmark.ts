...
export const indexingBenchmarks: BenchmarkDefinition<any>[] = [
  ...
  },
  {
    ...
    description:
      'Wraps already-prepared RGB buffers in the exact RawImage boundary used before processor execution.',
    iterations: 12,
    warmupIterations: 3,
  ...
  },
  {
    ...
    description:
      'Converts 512 synthetic 512-dimensional rows and normalizes every vector in JavaScript.',
    iterations: 10,
    warmupIterations: 3,
    operationsPerIteration: 512,
    setup: () => clipContext(512),
  ...
  },
  {
    ...
    description:
      'Builds the metadata and embedding records passed from CLIP inference into encrypted persistence.',
    iterations: 12,
    warmupIterations: 3,
    operationsPerIteration: 512,
  ...
  },
  {
    ...
    description:
      'Builds persisted MiniLM records while preserving document and PDF extraction metadata.',
    iterations: 12,
    warmupIterations: 3,
    operationsPerIteration: 512,
    setup: () => {
  ...
  },
  {
    ...
    description:
      'Calculates frame budget, probe timestamps, and thumbnail position for a four-hour video.',
    iterations: 15,
    warmupIterations: 4,
  ...
  },
  {
    ...
    description:
      'Reconnects CLIP results to sampled timestamps and creates independently searchable frame records.',
    iterations: 12,
    warmupIterations: 3,
  ...
  },
  {
    ...
    description:
      'Runs four deterministic spherical k-means iterations over 1,024 normalized 512-dimensional vectors.',
    iterations: 6,
    warmupIterations: 1,
    ...
    run: (context, iteration) =>
      trainConceptCentroids(context.vectors.slice(), 512, 16, 4, 17 + iteration),
  },
];
