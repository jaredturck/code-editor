...
export const application_theme_options: ApplicationThemeOption[] = [
  { id: 'system', label: 'System', colors: ['#111113', '#f4f4f5', '#38BDF8', '#d4d4d8'], default_accent: 'sky', light: false },
  { id: 'dark', label: 'Editor Dark', colors: ['#111113', '#18181b', '#38BDF8', '#d4d4d8'], default_accent: 'sky', light: false },
  { id: 'light', label: 'Editor Light', colors: ['#f4f4f5', '#ffffff', '#38BDF8', '#27272a'], default_accent: 'sky', light: true },
  { id: 'iris-dark', label: 'IRIS Dark', colors: ['#070817', '#0D0D1A', '#6C9EFF', '#F2F7FF'], default_accent: 'blue', light: false },
  { id: 'iris-light', label: 'IRIS Light', colors: ['#DCE4EF', '#E6ECF5', '#6C9EFF', '#0F172A'], default_accent: 'blue', light: true },
  { id: 'slate', label: 'Slate', colors: ['#1F1F1D', '#2A2A27', '#F59E0B', '#FFFAF1'], default_accent: 'amber', light: false },
  { id: 'rose', label: 'Rose', colors: ['#EAD6E1', '#F7E8F0', '#F472B6', '#301426'], default_accent: 'rose', light: true },
  { id: 'ocean', label: 'Ocean', colors: ['#091725', '#112A44', '#22D3EE', '#F0F9FF'], default_accent: 'cyan', light: false },
  { id: 'ember', label: 'Ember', colors: ['#1F1E1D', '#33322F', '#C96442', '#FFFFFF'], default_accent: 'clay', light: false },
  { id: 'dracula', label: 'Dracula', colors: ['#282A36', '#3C3F52', '#A855F7', '#FFFFFF'], default_accent: 'purple', light: false },
  { id: 'one-dark', label: 'One Dark', colors: ['#282C34', '#3A3F4B', '#6C9EFF', '#E6E6E6'], default_accent: 'blue', light: false },
  { id: 'monokai', label: 'Monokai', colors: ['#272822', '#3A3B33', '#34D399', '#FFFFFF'], default_accent: 'green', light: false },
  { id: 'nord', label: 'Nord', colors: ['#2E3440', '#434C5E', '#22D3EE', '#ECEFF4'], default_accent: 'cyan', light: false },
  { id: 'tokyo-night', label: 'Tokyo Night', colors: ['#1A1B26', '#2A2E42', '#6C9EFF', '#C0CAF5'], default_accent: 'blue', light: false },
  { id: 'night-owl', label: 'Night Owl', colors: ['#011627', '#122D44', '#6C9EFF', '#FFFFFF'], default_accent: 'blue', light: false },
  { id: 'solarized-dark', label: 'Solarized', colors: ['#002B36', '#0E4350', '#22D3EE', '#FDF6E3'], default_accent: 'cyan', light: false },
  { id: 'github-dark', label: 'GitHub Dark', colors: ['#0D1117', '#21262D', '#6C9EFF', '#F0F6FC'], default_accent: 'blue', light: false },
]
